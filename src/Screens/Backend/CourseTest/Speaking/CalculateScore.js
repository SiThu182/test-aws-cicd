let CalculatorScore = (
  ...
  alert(shortPauseCount);
  alert(longPauseCount);
  ...
  let content_max_point =
    category === "rs" || category === "rts" ? 3 : category === "asq" ? 1 : 5;
  ...
  let scores = {
    ...
    fluency: fluency,
    content: content,
    appropriacy: Math.round(content_ninety),
